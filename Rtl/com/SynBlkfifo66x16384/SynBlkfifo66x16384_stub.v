...
module SynBlkfifo66x16384(clk, srst, din, wr_en, rd_en, dout, full, empty, 
  prog_full)
/* synthesis syn_black_box black_box_pad_pin="clk,srst,din[65:0],wr_en,rd_en,dout[65:0],full,empty,prog_full" */;
  input clk;
  input srst;
  input [65:0]din;
  input wr_en;
